...
export default function ProductTable() {
  ...
  const handleEditSubmit = (values: Product) => {
          ...
          <TableBody>
            ...
            <StyledTableCell align="right"> ₹{item.sellingPrice}.0</StyledTableCell>
                   ...
                   <StyledTableCell align="right">
                     <Button
                       size="small"
                       color={item.quantity && item.quantity > 0 ? 'success' : 'error'}
                       variant={item.quantity && item.quantity > 0 ? 'contained' : 'outlined'}
                       onClick={() => handleToggleStock(item)}
                     >
                       {item.quantity && item.quantity > 0 ? 'in_stock' : 'out_of_stock'}
                     </Button>
                   </StyledTableCell>
                   <StyledTableCell align="right">
