...
const BecomeSeller = () => {
  ...
  const initialLoginMode = new URLSearchParams(location.search).get('mode') === 'login';

  const [isLoginPage, setIsLoginPage] = useState(initialLoginMode);
