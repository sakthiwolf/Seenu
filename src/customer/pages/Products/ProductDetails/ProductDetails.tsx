            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                ...
                <section className='flex flex-col lg:flex-row gap-5'>
                    <div className='w-full lg:w-[15%] flex flex-wrap lg:flex-col gap-3'>
                        {products.product?.images.map((item, index) => <img key={index} onClick={() => setSelectedImage(index)} className='lg:w-full w-[50px] cursor-pointer rounded-md' src={item} alt="" />)}
                    </div>
                ...
                <section>
                    ...
                    <div className="mt-12 flex items-center gap-5">
                        ...
                        <Button
                            ...
                            startIcon={productInWishlist ? <FavoriteIcon /> : <FavoriteBorderIcon />}>
